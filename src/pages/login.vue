  ...
  <main class="qm-login">
    <section class="qm-login-container">
      ...
      <div class="qm-login-content">
        ...
        />
        <div class="form-item">
          <Checkbox v-model:checked="checkedMemorizeUser" style="margin-left: 8px" />
          <p class="memorize-user-name">记住用户名</p>
        </div>
        <Button type="primary" class="qm-login-submit" @click="handleRegister">登录</Button>
      </div>
    </section>
...
.qm-login-illustration {
  ...
  height: 481px;
  margin-left: 40px;
  background: url(@/assets/images/login-bg-2.png) no-repeat left top / cover;
}
.qm-login-content {
  flex: 1;
  height: 100%;
